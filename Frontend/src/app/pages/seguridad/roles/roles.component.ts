...
export class RolesComponent implements OnInit {
  ...
  constructor(
    ...
    addEdit(id?:number){
      this.router.navigate([`home/seguridad/addEditRol/${id}`]);
    }
    ...
    actualizarEstado(idRol:number,estado:number){
      ...
      this._rolService.putEstadoRol(idRol,lista).subscribe(res=>{
        console.log('res: ', res);
    ...
    borrar(id:number){
      ...
      swalWithBootstrapButtons.fire({
        ...
        if (result.isConfirmed) {
          ...
          this._rolService.putEliminarRol(id,lista).subscribe((res:any) => {
            if (res.ok) {
